    ...
    <header class="header_section long_section px-0">
      <nav class="navbar navbar-expand-lg custom_nav-container ">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <div>
            <a class="" href="{{route('cartlist')}}"><i class="fa-solid fa-cart-shopping" style="color: #000000;"></i></a>
...
@endif
  ...
  <section class="furniture_section layout_padding" id="products">
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-md-6 col-lg-4">
          <div class="box">
            <div class="img-box">
              <img src="{{asset('file/'.$products->image)}}" alt="">
            </div>
            <div class="detail-box">
              <h5>
             {{ $products->name}}
             ...
             {{ $products->price}}
                ...
                <a href="{{route('cart',[$products->p_id])}}">
                  Buy Now
                </a>
              </div>
            </div>
  ...
  <section class="client_section layout_padding-bottom" id="Testimonial">
    <div class="container">
      <div class="heading_container">
        <h2>
          Testimonial
  ...
  <!-- info section -->
  <section class="info_section long_section" id="Footer">
